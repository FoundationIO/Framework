...
namespace LinqToDB
{
    public static class Linq2DbUtils
    {
        ...
        public static int UpdateWithAudit<T>(this IDataContext dataContext, T obj, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null)
            where T : IAuditableIdModel
        {
            obj.ModifiedBy = modifiedBy;
            obj.ModifiedDate = DateTime.UtcNow;
            return dataContext.Update<T>(obj, tableName, databaseName, schemaName);
        ...
        public static int UpdateWithAudit<T>(this IQueryable<T> source, Expression<Func<T, T>> setter, long? modifiedBy)
            where T : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static int UpdateWithAudit<TSource, TTarget>(this IQueryable<TSource> source, ITable<TTarget> target, Expression<Func<TSource, TTarget>> setter, string modifiedBy)
            where TSource : IAuditableNameModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static int UpdateWithAudit<TSource, TTarget>(this IQueryable<TSource> source, ITable<TTarget> target, Expression<Func<TSource, TTarget>> setter, long? modifiedBy)
            where TSource : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
            return source.Update(target, setter);
        ...
        public static int UpdateWithAudit<TSource, TTarget>(this IQueryable<TSource> source, Expression<Func<TSource, TTarget>> target, Expression<Func<TSource, TTarget>> setter, long? modifiedBy)
            where TSource : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static int UpdateWithAudit<T>(this IQueryable<T> source, Expression<Func<T, bool>> predicate, Expression<Func<T, T>> setter, long? modifiedBy)
            where T : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static int UpdateWithAudit<T>(this IUpdatable<T> source, long? modifiedBy)
            where T : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static Task<int> UpdateWithAuditAsync<T>(this IDataContext dataContext, T obj, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            obj.ModifiedBy = modifiedBy;
            obj.ModifiedDate = DateTime.UtcNow;
        ...
        public static Task<int> UpdateWithAuditAsync<TSource, TTarget>(this IQueryable<TSource> source, Expression<Func<TSource, TTarget>> target, Expression<Func<TSource, TTarget>> setter, long? modifiedBy, CancellationToken token = default)
            where TSource : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static Task<int> UpdateWithAuditAsync<TSource, TTarget>(this IQueryable<TSource> source, ITable<TTarget> target, Expression<Func<TSource, TTarget>> setter, long? modifiedBy, CancellationToken token = default)
            where TSource : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static Task<int> UpdateWithAuditAsync<T>(this IQueryable<T> source, Expression<Func<T, bool>> predicate, Expression<Func<T, T>> setter, long? modifiedBy, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static Task<int> UpdateWithAuditAsync<T>(this IQueryable<T> source, Expression<Func<T, T>> setter, long? modifiedBy, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static Task<int> UpdateWithAuditAsync<T>(this IUpdatable<T> source, long? modifiedBy, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            source.Set(x => x.ModifiedDate, DateTime.UtcNow);
            source.Set(x => x.ModifiedBy, modifiedBy);
        ...
        public static int InsertWithAudit<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static Task<int> InsertWithAuditAsync<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static int InsertOrReplaceWithAudit<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static Task<int> InsertOrReplaceWithAuditAsync<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static decimal InsertWithDecimalIdentityWithAudit<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static Task<decimal> InsertWithDecimalIdentityWithAuditAsync<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static object InsertWithIdentityWithAudit<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static Task<object> InsertWithIdentityWithAuditAsync<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static int InsertWithInt32IdentityWithAudit<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static Task<int> InsertWithInt32IdentityWithAuditAsync<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static long InsertWithInt64IdentityWithAudit<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
        ...
        public static Task<long> InsertWithInt64IdentityWithAuditAsync<T>(this IDataContext dataContext, T obj, long? createdBy, long? modifiedBy, string tableName = null, string databaseName = null, string schemaName = null, CancellationToken token = default)
            where T : IAuditableIdModel
        {
            obj.CreatedBy = createdBy;
            obj.CreatedDate = DateTime.UtcNow;
