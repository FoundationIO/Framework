...
namespace Framework.Infrastructure.Interfaces.Services
{
    public interface IEmailService
    {
        ...
        Task<ReturnModel<bool>> SendAsync(string smtpHost, int port, string userName, string password, bool useSSL, string fromDisplayName, string fromEmail, string toDisplayName, string toEmail, string ccEmail, string bccEmail, string subject, string body);
    }
}